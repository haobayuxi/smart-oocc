...
namespace {
const std::unordered_set<std::string> HAVE_VALS{"write_txn_sizes",
                                                "read_txn_sizes"};
const std::unordered_set<std::string> HAVE_TYPES{"edge_types",
                                                 "read_operation_types",
                                                 "write_operation_types",
                                                 "read_txn_operation_types",
                                                 "errors",
                                                 "txn_errors",
                                                 "operation_predicates",
                                                 "txn_predicates",
                                                 "txn_predicate_counts",
                                                 "read_tiers",
                                                 "write_txn_operation_types"};
const std::unordered_set<std::string> HAVE_NEITHER{
    "read_operation_latency", "write_operation_latency", "operations",
...
ConfigParser::ConfigParser() {
  std::string filepath = "../config/workload_a.json";
...
template std::vector<int> ConfigParser::LineObject::parseList<int>(
    std::string const &, const std::function<int(std::string &)> &);
template std::vector<double> ConfigParser::LineObject::parseList<double>(
    std::string const &, const std::function<double(std::string &)> &);
template std::vector<std::string>
ConfigParser::LineObject::parseList<std::string>(
    std::string const &, const std::function<std::string(std::string &)> &);
}  // namespace benchmark
